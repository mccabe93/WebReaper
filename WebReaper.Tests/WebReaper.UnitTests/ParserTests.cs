...
namespace WebReaper.UnitTests
{
    public class ParserTests
    {
        ...
        public async Task ParserSimpleTest()
        {
            ...
            Assert.Equal(
                "Эшбах Андреас - Выжжено [Оробчук Сергей, (ЛИ), 2022, 128 kbps, MP3]",
            ...
            Assert.Equal(
                "magnet:?xt=urn:btih:462F275C47EA0608B25BB8DFB1E202BDAFC68DE7&tr=http%3A%2F%2Fbt4.t-ru.org%2Fann%3Fmagnet",
                result["torrentLink"]?.ToString()
            );
            Assert.Equal(
                "https://www.hostpic.org/images/2210182146080117.jpg",
                result["coverImageUrl"]?.ToString()
            );
        }
        ...
        public async Task ParserSimpleHtmlParsingTest()
        {
            ...
            var result = await parser.ParseAsync(
                page,
                new() { new("link", ".attach_link.guest", true) }
            );
